...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull TextView emailTextView,
      @NonNull TextView passwordTextView, @NonNull TextView welcomeTextView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, emailTextView, passwordTextView,
          welcomeTextView);
    }
